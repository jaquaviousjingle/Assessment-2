...
class Map:
    ...
    def show_map(self):
        ...
        print("      /                \\")
        print(self.mark("West Deciduous Forest").ljust(24) + self.mark("East Deciduous Forest"))
        print("     |                  |")
        print(self.mark("West Taiga").ljust(24) + self.mark("East Taiga"))
        print("     |                  |")
        print(self.mark("West Tundra").ljust(24) + self.mark("East Tundra"))
        print("      \\                /")
